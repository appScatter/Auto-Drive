...
public class AdvancedAutoView extends AutoView
    ...
    public AdvancedAutoView(final Context context) {
        super(context);
    }

    public AdvancedAutoView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }
